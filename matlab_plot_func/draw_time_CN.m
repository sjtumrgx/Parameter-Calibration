...
% Legend
lgd1 = legend('RA-SGLO', 'CBO', 'GA', 'Location', 'NorthEast');
...
hold off;
xlabel('电池编号', 'FontSize', 18);
ylabel('收敛时间 (分钟)', 'FontSize', 18);
ax2_right = gca;
...
lgd2.Box = 'off';
lgd2.FontSize = 16;
exportgraphics(fig,'draw_time/Time_iter_comparison_CN.png','Resolution',300);
