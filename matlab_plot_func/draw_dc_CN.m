...
set(gcf, 'Color', 'white');
exportgraphics(fig1, ['./dc_plots/' prefix '_voltage_comparison_CN.png'], 'Resolution', 300);
...
set(gca, 'FontName', fontName, 'FontSize', fontSize);
set(gcf, 'Color', 'white');
exportgraphics(fig2, ['./dc_plots/' prefix '_voltage_residual_hist_CN.png'], 'Resolution', 300);
...
set(gca, 'FontName', fontName, 'FontSize', fontSize);
set(gcf, 'Color', 'white');
exportgraphics(fig3, ['./dc_plots/' prefix '_current_data_CN.png'], 'Resolution', 300);
...
set(gca, 'FontName', fontName, 'FontSize', fontSize);
set(gcf, 'Color', 'white');
exportgraphics(fig4, ['./dc_plots/' prefix '_soc_data_CN.png'], 'Resolution', 300);
