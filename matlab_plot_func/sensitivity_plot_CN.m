...
% Category labels
category_labels = {'几何参数', '结构参数', '传输参数', '初始状态参数'};
...
ax3 = ax1;
% Save figure
exportgraphics(ax1, fullfile(save_dir, 'total_order_sensitivity_CN.png'), 'Resolution', 300);
exportgraphics(ax3, fullfile(save_dir, 'total_order_sensitivity_CN.pdf'), 'Resolution', 300);
...
ax3 = ax2;
% Save figure
exportgraphics(ax2, fullfile(save_dir, 'first_order_sensitivity_CN.png'), 'Resolution', 300);
exportgraphics(ax3, fullfile(save_dir, 'first_order_sensitivity_CN.pdf'), 'Resolution', 300);
fprintf('敏感性分析图表已创建并保存为:\n');
fprintf('  - total_order_sensitivity_CN.png/.pdf\n');
fprintf('  - first_order_sensitivity_CN.png/.pdf\n'); 